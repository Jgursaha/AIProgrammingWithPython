...
def calculates_results_stats(results_dic):
    ...
    dogs_img_count = 0  #n_dogs_img - number of dog images
    notdogs_img_count = 0 #n_notdogs_img - number of NON-dog images
    match_count = 0 #n_match - number of matches between pet & classifier labels
    correct_dogs_count = 0 #n_correct_dogs - number of correctly classified dog images 
    correct_notdogs_count = 0 #n_correct_notdogs - number of correctly classified NON-dog images
    correct_breed_count = 0 #n_correct_breed - number of correctly classified dog breeds
    ...
    notdogs_img_count = len(results_dic) - dogs_img_count
